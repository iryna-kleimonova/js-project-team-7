import{a as c,S as B,N as M,P as S}from"./assets/vendor-Cj1XzFCq.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function s(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(r){if(r.ep)return;r.ep=!0;const a=s(r);fetch(r.href,a)}})();const n={burger:document.querySelector(".js-burger"),closeBtn:document.querySelector(".js-close"),navList:document.querySelector(".js-nav-list"),navLinks:document.querySelectorAll(".nav-button"),header:document.querySelector(".header"),heroSection:document.querySelector(".js-hero"),getStartedBtn:document.querySelector(".js-hero-button"),artistCardsContainer:document.querySelector(".js-artist-list"),artistCards:document.querySelectorAll(".js-artist-card"),loadMoreBtn:document.querySelector(".load-more-btn"),loader:document.getElementById("loader"),toggleFiltersBtn:document.getElementById("toggle-filters"),filtersContainer:document.getElementById("filters-container"),genreButton:document.getElementById("genre-button"),genreMenu:document.getElementById("genre-menu"),sortingDropdown:document.querySelector("#sorting-dropdown"),sortingMenu:document.querySelector("#sorting-menu"),modal:document.querySelector(".js-modal"),modalCloseBtn:document.querySelector(".js-modal-close"),modalContent:document.querySelector(".js-modal-content"),modalFilters:document.querySelector(".js-modal-filters"),modalBody:document.querySelector(".js-modal-body"),aboutSection:document.querySelector(".js-about"),aboutImage:document.querySelector(".js-about-image"),aboutText:document.querySelector(".js-about-text"),testimonialsSection:document.querySelector(".js-testimonials"),testimonialsSlider:document.querySelector(".js-testimonials-slider"),testimonialPrevBtn:document.querySelector(".js-testimonials-btn-prev"),testimonialNextBtn:document.querySelector(".js-testimonials-btn-next"),footer:document.querySelector(".js-footer")},E=new IntersectionObserver(([e])=>{e.isIntersecting&&n.footer.classList.add("footer--visible")},{threshold:.8});E.observe(n.footer);c.defaults.baseURL="https://sound-wave.b.goit.study/api";async function k(e=1,t=8){try{const o=`https://sound-wave.b.goit.study/api/artists?page=${e}&limit=${t}`,r=await fetch(o);if(!r.ok)throw new Error(`HTTP error! status: ${r.status}`);return await r.json()}catch(s){throw console.error("Error in fetchArtists:",s),s}}async function q(e){try{return(await c.get(`/artists/${e}`)).data}catch(t){throw console.error("Error in fetchArtistById:",t),t}}async function j(e){try{return(await c.get(`/artists/${e}/albums`)).data.albumsList}catch(t){throw console.error("Error in fetchArtistsAlbumsById:",t),t}}async function A(){try{return(await c.get("/genres")).data}catch{}}async function I(e){try{return(await c.get(`/artists?genre=${e}`)).data}catch{}}const y="/js-project-team-7/assets/sprite-3VxN5qeB.svg";function h(e){const t=e.artists.map(s=>{const{_id:o,strArtist:r,strBiographyEN:a,strArtistThumb:i,genres:l}=s;return`
        ...
        </li>`}).join("");n.artistCardsContainer.insertAdjacentHTML("beforeend",t)}const C=document.querySelector(".artists-info"),u=document.querySelector(".artists-albums");function T(e){const{strArtist:t="-",strArtistThumb:s,intFormedYear:o,intDiedYear:r,strGender:a="-",intMembers:i,strCountry:l="-",strBiographyEN:d="-",genresList:g=[]}=e,v=o?r?`${o} - ${r}`:`${o} - present`:"-",L=g.length?g.map($=>`<button class="genre-btn">${$}</button>`).join(""):"-",w=`
  ...
  `;C.innerHTML=w}function P(e=[]){if(u.innerHTML="",!e.length){u.innerHTML="<p>-</p>";return}const t=e.map(s=>{const o=s.tracks&&s.tracks.length?s.tracks.map(r=>`
                <li class="track-item">
